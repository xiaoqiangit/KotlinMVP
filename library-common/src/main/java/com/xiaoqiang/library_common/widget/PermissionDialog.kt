...
import com.xiaoqiang.library_common.utils.clickUtils.NoDoubleClickListener
import kotlinx.android.synthetic.main.common_dialog_permission.view.*
...
class PermissionDialog : DialogFragment() {
    ...
    companion object {
        ...
        const val CANCEL_ABLE = "cancel_able"
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.common_dialog_permission, container, false)
        initView(rootView)
        return rootView
    }
    ...
    private fun initView(view: View) {
        ...
        view.tv_confirm.setOnClickListener(object : NoDoubleClickListener() {
            override fun onNoDoubleClick(v: View?) {
                onConfirmClickListener?.invoke()
                dismiss()
            }
        })
        view.tv_cancel.setOnClickListener(object : NoDoubleClickListener() {
            override fun onNoDoubleClick(v: View?) {
